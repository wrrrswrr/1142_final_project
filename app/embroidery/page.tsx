...
function BlushDetailContent() {
  ...
  const hotspot = INVESTIGATION_HOTSPOTS.find(h => h.id === paramId) || 
                  INVESTIGATION_HOTSPOTS.find(h => h.id === '8') ||
                  INVESTIGATION_HOTSPOTS.find(h => h.name.includes('床頭刺繡'));
  ...
  return (
    ...
    >
      ...
      >
        <img 
          src={hotspot.detailBackgroundUrl || "/embroidery.png"} 
          alt={hotspot.name} 
        ...
        {showBottomText && (
          ...
          >
            <div className="relative group">
              ...
              「「這副鴛鴦圖她前幾日就繡完了。她曾笑著說，這宮裡不指望有真心人，繡給自己看、圖個喜氣也好。繡品還這麼嶄新平整，看著它的人卻已經不在了……」
              </p>

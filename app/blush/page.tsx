...
function BlushDetailContent() {
  ...
  // 如果沒有 id 參數，嘗試找名稱包含 "胭脂" 的資料或 id 為 "7" 的資料
  ...
  const hotspot = INVESTIGATION_HOTSPOTS.find(h => h.id === paramId) ||
    INVESTIGATION_HOTSPOTS.find(h => h.id === '7') ||
    INVESTIGATION_HOTSPOTS.find(h => h.name.includes('胭脂'));
  ...
  return (
    ...
    >
      ...
      >
        <img
          src={hotspot.detailBackgroundUrl || "/blush.png"}
          alt={hotspot.name}
        ...
        {showBottomText && (
          ...
          >
            <div className="relative group">
              ...
              「這是她生前最愛的胭脂，還剩大半盒...明明說好下個月初一，要一起抹著它去御花園賞梅的...」
              </p>

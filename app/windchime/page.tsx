...
function BlushDetailContent() {
  ...
  const hotspot = INVESTIGATION_HOTSPOTS.find(h => h.id === paramId) || 
                  INVESTIGATION_HOTSPOTS.find(h => h.id === '9') ||
                  INVESTIGATION_HOTSPOTS.find(h => h.name.includes('窗邊的風鈴'));
  ...
  return (
    ...
    >
      ...
      >
        <img 
          src={hotspot.detailBackgroundUrl || "/wind_chime.png"} 
          alt={hotspot.name} 
        ...
        {showBottomText && (
          ...
          >
            <div className="relative group">
              ...
              「這風鈴是我們剛入宮、還只是答應時一起做的。如今鈴聲依舊清脆，這深宮卻只剩我一個人了...」
              </p>
